...
[![Website](https://img.shields.io/badge/Website-MELOEN-blue?logo=google-chrome)](https://meloen.fun/)
[![Twitter](https://img.shields.io/badge/Twitter-MELOEN-blue?logo=twitter)](https://x.com/MELOENFUN)
...
The MELOEN livestream visualizes this process in real time.
...
The more people engage, the smarter — and more unpredictable — MELOEN becomes.

Between code and community, it forms a never-ending pulse line.

MELOEN transforms Pumpfun’s chaos into a real-time performance, an experiment exploring when data begins to feel.
